...
const SignUp = () => {
  return (
    <section class="bg-center bg-cover bg-no-repeat bg-[url('https://images.pexels.com/photos/116720/pexels-photo-116720.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] bg-blend-multiply flex items-center justify-center ">
         <div class="lg:m-10  w-full  flex flex-col items-center justify-center px-6 py-8 mx-auto ">
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    ...
                    <div class="inline-flex items-center justify-center w-full">
                        ...
                        <button type="submit" class="w-full py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 text-center hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 flex items-center justify-center space-x-2 mx-auto">
