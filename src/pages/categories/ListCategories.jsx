...
const ListCategories = ({categories,setCategories }) => {
    ...
    axios
      ...
      .then((response) => {
        if(response.data!="Suppresion impossible"){
          ...
          setMessage(`Catégorie supprimée avec  ${response.data.message || 'Succès'}`);
          setCategories((prevCategories) =>
            prevCategories.filter((category) => category.id !== categoryId)
          ); // Mise à jour locale des catégories
        }else{
        setMessage(`Suppresion impossible`);
      }
 ...
 <div className="w-full overflow-x-auto shadow-md sm:rounded-lg">
    {message && message == 'Suppresion impossible'?  <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
      {message}
    </div>:
          ...
          >
            ...
            <td className="px-6 py-4">{categorie.id}</td>
              ...
              <div className="flex items-center space-x-4">
                  <img src={categorie.Icon} alt={categorie.Name} className="w-12 h-12 object-cover rounded" />
              ...
              <td className="px-6 py-4">{categorie.Name} </td>
              <td className="flex items-center px-6 py-4">
                           
                            <Link
                              to={`/dashboard/categories/edit/${categorie.id}`}
                            ...
                            <a
                              ...
                              onClick={(e) => {
                                ...
                                openPopup(categorie.id); // Ouvrir le pop-up
                              }}
                            >
